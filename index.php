    	...
    	<div class="col-6 mx-auto shadow-lg main px-0">
    		...
    		<div class="text-center"> <!-- Див для списка фильмов -->
               <?php
                    $database = [
                       "id" = ["1. ","2. ","3. ","4. ","5. "],
                        "name" = [" Побег из шоушенка"," Зелёная миля"," Форест гам","Терминатор","Форсаж: Токийский дрифт"],
                        "img" = ["img/1.jpg","img/2.jpg","img/3.jpg","img/4.jpg","img/5.jpg"],
                    ];

                    for($i=0; $i<5; $i++){
                       echo "<h1>". $database[0][$i] . $database[1][$i] ."</h1>";
                       echo "<img src='". $database[2][$i] ."' style='margin-bottom: 50px; height: 496px; width: 350px'>"; 
                    }
               ?>
    		</div>
    	</div>
